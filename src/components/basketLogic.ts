...
class Basket {
    ...
    drawItems() {
        ...
        <div class="basket-items__item-bottom">
          <div class="basket-items__item-price">
            ...
            <span class="basket-items__item-price-num">${itemData.price} руб.</span>
          </div>
    ...
    pagination(limit = 3, page = 1) {
        ...
        console.log(this.testQueryParameters);
        return 1;
    }
}
...
class BasketMemory {
    ...
    addItemToBasket(id: string) {
        ...
        const item: basketItem = { id: Number(id), order: this.order, itemQnt: 1 };
